    ...
    <div className={`flex h-screen bg-gray-50 dark:bg-gray-900 ${theme === "dark" ? "dark" : ""}`}>
      ...
      <div className="flex-1 flex flex-col w-full overflow-hidden">
        ...
        <div className="flex-1 overflow-hidden flex flex-col md:flex-row gap-6 p-3 md:p-8">
          ...
          <aside className="hidden lg:flex flex-col gap-4 w-full lg:w-80 flex-shrink-0 h-screen sticky top-0">
            {/* Ads Banner - Vertical - FIXO AO ROLAR */}
            <div className="bg-gradient-to-br from-orange-400 to-orange-600 rounded-lg shadow-lg p-6 text-white min-h-96 flex flex-col items-center justify-center text-center sticky top-0">
