...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        "focus:bg-[var(--accent-soft)] focus:text-[var(--text-primary)] relative flex cursor-default items-center gap-2 rounded-[calc(var(--radius-control)-2px)] py-1.5 pr-2 pl-8 text-sm outline-hidden select-none nexo-state-transition data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      checked={checked}
      {...props}
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-[var(--accent-soft)] focus:text-[var(--text-primary)] data-[state=open]:bg-[var(--accent-soft)] data-[state=open]:text-[var(--text-primary)] [&_svg:not([class*='text-'])]:text-[var(--text-muted)] flex cursor-default items-center gap-2 rounded-[calc(var(--radius-control)-2px)] px-2.5 py-2 text-sm outline-hidden select-none nexo-state-transition data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
