...
export const appointmentSchema = z.object({
  customerId: z.number().positive('Selecione um cliente'),
...
export const serviceOrderSchema = z.object({
  customerId: z.number().positive('Selecione um cliente'),
  appointmentId: z.number().positive('Selecione um agendamento').optional(),
...
export const chargeSchema = z.object({
  customerId: z.number().positive('Selecione um cliente'),
  serviceOrderId: z.number().positive('Selecione uma ordem de serviço').optional(),
  ...
  paymentMethod: z.enum(['CREDIT_CARD', 'DEBIT_CARD', 'BANK_TRANSFER', 'PIX', 'BOLETO']).optional(),
  notes: z.string().optional(),
});
