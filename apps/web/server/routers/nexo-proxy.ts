...
export const nexoProxyRouter = router({
  ...
  finance: router({
    ...
    charges: router({
      list: publicProcedure.input(z.any().optional()).query(async ({ input, ctx }) => {
        ...
        return await nexoFetch(`/finance/charges${query}`, {
          headers: authHeader ? { Authorization: authHeader } : {},
        });
      }),
      ...
      stats: publicProcedure.query(async ({ ctx }) => {
        const authHeader = getAuthHeader(ctx as CtxLike);
        return await nexoFetch("/finance/charges/stats", {
          headers: authHeader ? { Authorization: authHeader } : {},
        });
      }),
      ...
      revenueByMonth: publicProcedure.query(async ({ ctx }) => {
        const authHeader = getAuthHeader(ctx as CtxLike);
        return await nexoFetch("/finance/charges/revenue-by-month", {
          headers: authHeader ? { Authorization: authHeader } : {},
        });
      }),
  ...
  expenses: router({
    list: publicProcedure.input(z.any().optional()).query(async ({ input, ctx }) => {
      ...
      return await nexoFetch(`/expenses${query}`, {
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    }),
    ...
    create: publicProcedure.input(z.any()).mutation(async ({ input, ctx }) => {
      const authHeader = getAuthHeader(ctx as CtxLike);
      return await nexoFetch("/expenses", {
        method: "POST",
        body: JSON.stringify(input),
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    ...
    update: publicProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        const authHeader = getAuthHeader(ctx as CtxLike);
        return await nexoFetch(`/expenses/${input.id}`, {
          method: "PATCH",
          body: JSON.stringify(input.data),
          headers: authHeader ? { Authorization: authHeader } : {},
        });
  ...
  invoices: router({
    list: publicProcedure.input(z.any().optional()).query(async ({ input, ctx }) => {
      ...
      return await nexoFetch(`/invoices${query}`, {
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    }),
    ...
    create: publicProcedure.input(z.any()).mutation(async ({ input, ctx }) => {
      const authHeader = getAuthHeader(ctx as CtxLike);
      return await nexoFetch("/invoices", {
        method: "POST",
        body: JSON.stringify(input),
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    ...
    update: publicProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        const authHeader = getAuthHeader(ctx as CtxLike);
        return await nexoFetch(`/invoices/${input.id}`, {
          method: "PATCH",
          body: JSON.stringify(input.data),
          headers: authHeader ? { Authorization: authHeader } : {},
        });
    ...
    summary: publicProcedure.query(async ({ ctx }) => {
      const authHeader = getAuthHeader(ctx as CtxLike);
      return await nexoFetch("/invoices/summary", {
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    }),
  }),
  ...
  governance: router({
    summary: publicProcedure.query(async ({ ctx }) => {
      const authHeader = getAuthHeader(ctx as CtxLike);
      return await nexoFetch("/governance/summary", {
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    }),
    ...
    runs: publicProcedure.input(z.any().optional()).query(async ({ input, ctx }) => {
      ...
      return await nexoFetch(`/governance/runs${query}`, {
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    }),
    ...
    autoScore: publicProcedure.query(async ({ ctx }) => {
      const authHeader = getAuthHeader(ctx as CtxLike);
      return await nexoFetch("/governance/auto-score", {
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    }),
  }),
  ...
  dashboard: router({
    metrics: publicProcedure.query(async ({ ctx }) => {
      const authHeader = getAuthHeader(ctx as CtxLike);
      return await nexoFetch("/dashboard/metrics", {
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    }),
    ...
    revenue: publicProcedure.query(async ({ ctx }) => {
      const authHeader = getAuthHeader(ctx as CtxLike);
      return await nexoFetch("/dashboard/revenue", {
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    }),
    ...
    growth: publicProcedure.query(async ({ ctx }) => {
      const authHeader = getAuthHeader(ctx as CtxLike);
      return await nexoFetch("/dashboard/growth", {
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    }),
    ...
    serviceOrdersStatus: publicProcedure.query(async ({ ctx }) => {
      const authHeader = getAuthHeader(ctx as CtxLike);
      return await nexoFetch("/dashboard/service-orders-status", {
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    }),
    ...
    chargesStatus: publicProcedure.query(async ({ ctx }) => {
      const authHeader = getAuthHeader(ctx as CtxLike);
      return await nexoFetch("/dashboard/charges-status", {
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    }),
    ...
    alerts: publicProcedure.query(async ({ ctx }) => {
      const authHeader = getAuthHeader(ctx as CtxLike);
      return await nexoFetch("/dashboard/alerts", {
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    }),
  }),
  ...
  reports: router({
    executive: publicProcedure.query(async ({ ctx }) => {
      const authHeader = getAuthHeader(ctx as CtxLike);
      return await nexoFetch("/reports/executive-report", {
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    }),
    ...
    metrics: publicProcedure.input(z.any().optional()).query(async ({ input, ctx }) => {
      ...
      return await nexoFetch(`/reports/metrics${query}`, {
        headers: authHeader ? { Authorization: authHeader } : {},
      });
    }),
  }),
