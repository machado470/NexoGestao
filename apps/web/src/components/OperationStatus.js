...
export default function OperationStatus() {
    ...
    const config = {
        NORMAL: {
            ...
            description: 'Nenhum risco operacional ativo no momento.',
        },
        WARNING: {
    ...
    return (_jsxs("div", { className: `
        ...
        ${current.tone}
      `, children: [_jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round", className: "mt-0.5", children: _jsx("path", { d: "M12 3l8 4v5c0 5-3.5 9-8 10-4.5-1-8-5-8-10V7l8-4z" }) }), _jsxs("div", { className: "flex-1", children: [_jsx("div", { className: "text-sm font-semibold", children: current.title }), _jsx("div", { className: "text-sm opacity-80 mt-0.5", children: current.description })] })] }));
}
