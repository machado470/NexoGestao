...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_20%_20%,rgba(249,115,22,0.22),transparent_45%)]" />
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_80%_60%,rgba(249,115,22,0.18),transparent_50%)]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 w-full items-center">
          ...
          <div>
            ...
            <h1 className="text-4xl md:text-5xl xl:text-6xl font-semibold text-white leading-tight">
              Decisões jurídicas
              <br />
              <span className="text-[#F97316]">sustentadas por dados reais</span>
            </h1>

            <p className="mt-8 text-lg text-slate-300 max-w-xl">
              Treinamento, risco humano e auditoria em um sistema único,
              rastreável e defensável — do primeiro acesso à ação corretiva.
            </p>
          ...
          <div className="relative">
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-[#F97316]">Tempo real</span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6">
                <div className="space-y-1">
                  ...
                  <div className="text-xs text-slate-400">Riscos ativos</div>
                </div>

                <div className="space-y-1">
                  <div className="text-3xl font-semibold text-[#F97316]">
                    {kpi.compliance}%
                  </div>
                  <div className="text-xs text-slate-400">Conformidade</div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-xs text-slate-400">Ações pendentes</div>
                </div>
              </div>
            ...
            {/* GLOW CONTROLADO */}
            <div className="pointer-events-none absolute inset-0 -z-10 rounded-3xl bg-[#F97316]/10 blur-3xl" />
          </div>
        </div>
      </div>
    </section>
