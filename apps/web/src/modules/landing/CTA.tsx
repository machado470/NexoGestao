        ...
        <div className="max-w-5xl mx-auto px-6 py-40">
          ...
          >
            ...
            <p className="mt-6 text-lg text-slate-300 max-w-2xl mx-auto">
              Veja o NexoGestao operando em um ambiente real ou entre diretamente
              no sistema se você já possui acesso.
            </p>
            ...
            <p className="mt-8 text-sm text-slate-400">
              Sem compromisso comercial. Sem pressão. Apenas uma visão clara do
              funcionamento.
            </p>
          </Card>
        </div>
