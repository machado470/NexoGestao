...
export default function EvaluationsPage() {
  ...
  return (
    <SectionBase>
      <PageHeader title="Avaliações" description="Registrar avaliação e impacto no risco" />

      <Card className="max-w-xl">
        <div className="space-y-4">
          <div>
            <label className="text-sm opacity-60">Assignment ID</label>
            <input
              value={assignmentId}
          ...
          <div>
            <label className="text-sm opacity-60">Score ({score})</label>
            <input
              type="range"
              min={0}
              max={100}
